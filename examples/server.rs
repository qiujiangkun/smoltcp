...
fn main() {
    ...
    let tcp1_handle = sockets.add_tcp(tcp1_socket);
    let tcp2_handle = sockets.add_tcp(tcp2_socket);
    let tcp3_handle = sockets.add_tcp(tcp3_socket);
    let tcp4_handle = sockets.add_tcp(tcp4_socket);
    ...
    loop {
        ...
        {
            let socket = sockets.get_tcp(tcp1_handle).unwrap();
            if !socket.is_open() {
        ...
        {
            let socket = sockets.get_tcp(tcp2_handle).unwrap();
            if !socket.is_open() {
        ...
        // tcp:6971: sinkhole
        {
            let socket = sockets.get_tcp(tcp3_handle).unwrap();
            if !socket.is_open() {
        ...
        // tcp:6972: fountain
        {
            let socket = sockets.get_tcp(tcp4_handle).unwrap();
            if !socket.is_open() {
